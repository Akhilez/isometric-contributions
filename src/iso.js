...
const loadColors = () => {
    ...
    new obelisk.CubeColor().getByHorizontalColor(
      Number.parseInt(
        getComputedStyle(document.documentElement)
          .getPropertyValue("--color-calendar-graph-day-bg")
          .replace("#", ""),
        16
      )
    ),
    new obelisk.CubeColor().getByHorizontalColor(0x9ccc9c),
    new obelisk.CubeColor().getByHorizontalColor(
      Number.parseInt(
        getComputedStyle(document.documentElement)
  ...
  halloweenColors = [
    new obelisk.CubeColor().getByHorizontalColor(
      Number.parseInt(
        getComputedStyle(document.documentElement)
          .getPropertyValue("--color-calendar-halloween-graph-day-bg")
          .replace("#", ""),
        16
      )
    ),
    new obelisk.CubeColor().getByHorizontalColor(
      Number.parseInt(
        getComputedStyle(document.documentElement)
          .getPropertyValue("--color-calendar-halloween-graph-day-L1-bg")
          .replace("#", ""),
        16
      )
    ),
    new obelisk.CubeColor().getByHorizontalColor(
      Number.parseInt(
        getComputedStyle(document.documentElement)
          .getPropertyValue("--color-calendar-halloween-graph-day-L2-bg")
          .replace("#", ""),
        16
      )
    ),
    new obelisk.CubeColor().getByHorizontalColor(
      Number.parseInt(
        getComputedStyle(document.documentElement)
          .getPropertyValue("--color-calendar-halloween-graph-day-L3-bg")
          .replace("#", ""),
        16
      )
    ),
    new obelisk.CubeColor().getByHorizontalColor(
      Number.parseInt(
        getComputedStyle(document.documentElement)
          .getPropertyValue("--color-calendar-halloween-graph-day-L4-bg")
          .replace("#", ""),
        16
      )
    ),
    ...
    default:
      if (fill.includes("#")) {
        return new obelisk.CubeColor().getByHorizontalColor(
          Number.parseInt("0x" + fill.replace("#", ""), 16)
        );
      }
  }
};
...
const renderIsometricChart = () => {
  ...
  const firstRect = document.querySelectorAll(
    ".js-calendar-graph-svg g > g"
  )[1];
  const canvas = document.querySelector("#isometric-contributions");
  const GH_OFFSET =
    Number.parseInt(firstRect.getAttribute("transform").match(/(\d+)/)[0], 10) -
    1;
  ...
  weeks.forEach((w) => {
    const x =
      Number.parseInt(w.getAttribute("transform").match(/(\d+)/)[0], 10) /
      (GH_OFFSET + 1);
    w.querySelectorAll("rect").forEach((r) => {
      ...
      if (maxCount > 0) {
        cubeHeight += Number.parseInt(
          (MAX_HEIGHT / maxCount) * contribCount,
          10
        );
      }
...
const renderStats = () => {
  ...
  document
    .querySelector(".ic-contributions-wrapper")
    .append(icStatsBlockBottom);
};
